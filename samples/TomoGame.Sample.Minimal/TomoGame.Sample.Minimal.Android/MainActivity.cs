...
using TomoGame.Sample.Minimal.Core;

namespace TomoGame.Sample.Minimal.Android
{
    /// <summary>
    ...
    {
        private TomoGame.Sample.MinimalGame _game;
        private View _view;
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            _game = new TomoGame.Sample.MinimalGame();
