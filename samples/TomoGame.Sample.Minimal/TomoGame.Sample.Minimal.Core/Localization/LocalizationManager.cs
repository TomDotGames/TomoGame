...
namespace TomoGame.Sample.Minimal.Core.Localization
{
    /// <summary>
    ...
    internal class LocalizationManager
    {
        ...
        public static List<CultureInfo> GetSupportedCultures()
        {
            ...
            ResourceManager resourceManager = new ResourceManager("TomoGame.Sample.Minimal.Core.Localization.Resources", assembly);
