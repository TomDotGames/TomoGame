...
using TomoGame.Samples.Minimal.Core;

namespace TomoGame.Samples.Minimal.Android
{
    /// <summary>
    ...
    /// </remarks>
    [Activity(
        Label = "TomoGame.Samples.Minimal",
        MainLauncher = true,
        Icon = "@drawable/icon",
    ...
    {
        private TomoGame.Samples.MinimalGame _game;
        private View _view;
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            _game = new TomoGame.Samples.MinimalGame();
